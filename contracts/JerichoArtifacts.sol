...
contract JerichoArtifacts is ERC1155, Pausable, ERC1155Burnable, ContextMixin, NativeMetaTransaction {
    ...
    constructor(string memory _name, string memory _symbol) ERC1155("https://ipfs.io/ipfs/bafybeicyff3gyh6kd35d75eh3qsb3le3v5sillme35we5nd6t7cq3fregi/{id}.json") {
        name = _name;
        symbol = _symbol;
    ...
    function uri(uint256 _tokenid) override public pure returns (string memory) {
        return string(
            abi.encodePacked(
                "https://ipfs.io/ipfs/bafybeicyff3gyh6kd35d75eh3qsb3le3v5sillme35we5nd6t7cq3fregi/",
    ...
    function mintGatePass() public{
        _mint(msg.sender,GATE_PASS,1,"0x000");
    }

    // If you do not have any Gate Pass the contract will let you buy the Anvil
    function mintAnvil() public{
        require(balanceOf(msg.sender,GATE_PASS) > 0,"you need to have a Gate Pass");
        _mint(msg.sender,ANVIL,1,"0x000");
    }
    ...
    function mintNecklaceOfFrenship() public{
        require(balanceOf(msg.sender,GATE_PASS) > 0,"you need to have a Gate Pass");
        require(balanceOf(msg.sender,ANVIL) > 0,"you need to have a Anvil");
        _mint(msg.sender,NECKLACE_OF_FRENSHIP,1,"0x000");
    }
    ...
    function mintHammer() public{
        require(balanceOf(msg.sender,GATE_PASS) > 0,"you need to have a Gate Pass");
        require(balanceOf(msg.sender,ANVIL) > 0,"you need to have a Anvil");
        require(balanceOf(msg.sender,NECKLACE_OF_FRENSHIP) > 0,"you need to have a Necklace of Frenship");
