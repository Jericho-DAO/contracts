...
contract JerichoArtifacts is ERC1155, Pausable, ERC1155Burnable, ERC2771Context {
    ...
    constructor(string memory _name, string memory _symbol, address _trustedForwarder) ERC1155("https://ipfs.io/ipfs/bafybeicyff3gyh6kd35d75eh3qsb3le3v5sillme35we5nd6t7cq3fregi/{id}.json") ERC2771Context(_trustedForwarder) {
        name = _name;
        symbol = _symbol;
    }
    ...
    function mintNecklaceOfFrenship() public{
        require(balanceOf(_msgSender(),GATE_PASS) > 0,"you need to have a Gate Pass");
        require(balanceOf(_msgSender(),ANVIL) > 0,"you need to have a Anvil");
